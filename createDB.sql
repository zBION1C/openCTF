...
ALTER TABLE CTF
	ADD FOREIGN KEY (utente) REFERENCES Utente (username) ON UPDATE CASCADE;
...
ALTER TABLE Files
	ADD FOREIGN KEY (ctf) REFERENCES CTF (id) ON DELETE CASCADE;
...
INSERT INTO Utente (username, password, admin, banned, data) VALUES ('admin', 'admin', true, false, NOW());